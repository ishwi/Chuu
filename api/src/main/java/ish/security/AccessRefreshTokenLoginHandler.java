...
@Singleton
@Replaces(io.micronaut.security.token.jwt.bearer.AccessRefreshTokenLoginHandler.class)
public class AccessRefreshTokenLoginHandler {
    ...
    public MutableHttpResponse<?> loginRefresh(Authentication userDetails, String refreshToken, HttpRequest<?> request) {
