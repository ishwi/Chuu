...
public class CustomInterfacedEventManager implements IEventManager {
	...
	/**
	 * @param event We are taking advantage from only using three types of events in the whole bot , so we avoid less checking, for the momnent those are MessageReceivedEvent, GuildMemberLeaveEvent and MessageReactionAddEvent
	 *              If  you are using any other , pls modify the code or use the default one
	 */
	@Override
