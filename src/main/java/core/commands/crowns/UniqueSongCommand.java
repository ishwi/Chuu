...
public class UniqueSongCommand extends ConcurrentCommand<ChuuDataParams> {
    ...
    protected void onCommand(Context e, @NotNull ChuuDataParams params) {
        ...
        UniqueWrapper<TrackPlays> resultWrapper = getList(e.getGuild().getIdLong(), lastFmName);
        ...
        embedBuilder.setDescription(a).setTitle(String.format("%s's%s unique songs", userInfo.getUsername(), isGlobal() ? " global" : ""), CommandUtil
