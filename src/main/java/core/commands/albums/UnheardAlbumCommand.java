...
public class UnheardAlbumCommand extends ConcurrentCommand<NumberParameters<ArtistParameters>> {
    ...
    public List<String> getAliases() {
        return List.of("unheardalbum", "albumnotlistened", "albumtolisten", "unheardalb", "unheardal", "albunheard");
    }

    @Override
    public String getName() {
        return "Unheard album";
    }
    ...
    public void onCommand(Context e, @NotNull NumberParameters<ArtistParameters> numberParameters) throws LastFmException, InstanceNotFoundException {
        ...
        List<UnheardCount> unheardAlbums = db.getUnheardAlbums(lastFmName, who.getArtistId(), params.hasOptional("listeners"), extraParam);
