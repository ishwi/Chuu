...
public class ChartYearParameters extends ChartParameters {
    ...
    public ChartYearParameters(String username, long discordId, TimeFrameEnum timeFrameEnum, int x, int y, MessageReceivedEvent e, boolean writeTitles, boolean writePlays, boolean isList, boolean isPie, Year year, boolean careAboutSized) {
