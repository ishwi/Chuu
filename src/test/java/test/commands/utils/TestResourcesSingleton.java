...
public class TestResourcesSingleton extends ExternalResource {
    ...
    public static void deleteCommonArtists() {
        dao.insertNewUser(new LastFMData("guilleecs", ogJDA.getSelfUser().getIdLong(), channelWorker
                .getGuild().getIdLong(), setUp, true, WhoKnowsMode.IMAGE, ChartMode.IMAGE, RemainingImagesMode.IMAGE, 5, 5, PrivacyMode.DISCORD_NAME, true, true, showBotted, TimeZone.getDefault(), token, session));
    ...
    public static void insertCommonArtistWithPlays(int plays) {
        dao.insertNewUser(new LastFMData("guilleecs", ogJDA.getSelfUser().getIdLong(), channelWorker
                .getGuild().getIdLong(), true, true, WhoKnowsMode.IMAGE, ChartMode.IMAGE, RemainingImagesMode.IMAGE, 5, 5, PrivacyMode.DISCORD_NAME, true, true, showBotted, TimeZone.getDefault(), token, session));
        ArrayList<ScrobbledArtist> scrobbledArtistData = new ArrayList<>();
