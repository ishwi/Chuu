...
public class GenericEmbedMatcher {

	private static final TriFunction<String, Pattern, Predicate<Matcher>, Boolean> internalFunction = (string, regex, matcherPredicate) -> {
		if (string != null) {
			if (regex != null) {
	...
	private static final FieldMatcher internalMatcher = (field, string, pattern, matcherPredicate) -> {
	...
	public static void GeneralFunction(String command,
	                                   Pattern footerPatern, Predicate<Matcher> footerMatch, Pattern titlePattern,
	                                   Predicate<Matcher> titleMatch, Pattern descriptionPattern, Predicate<Matcher> descriptionMatch, Pattern noEmbbed, Predicate<Matcher> noEmbbedMatcher, int timeout, boolean hasThumbnail, String thumbnailUrl, List<FieldRowMatcher> fieldRowMatchers) {
